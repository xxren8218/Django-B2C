...
# ajax发起的请求都在后台，在浏览器中看不到效果。不能用MIxIn,需要自己做判断
# /cart/add
class CartAddView(View):
    ...
    def post(self, request):
        ...
        # 如果 sku_id 在 hash 中不存在，hget 返回的是 None
        ...
        # 设置 hash 中 sku_id 对应的值
        # hset -> 如果sku_id 已经存在，更新数据，若不存在，添加数据！
...
# 更新购物车的记录
# 采用ajax，post请求
# 前端需要传递的商品的参数：商品id(sku_id)，更新商品的数目(count)
# /cart/update
